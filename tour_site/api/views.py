...
class TourLengthFilterBackend(BaseFilterBackend):
    def filter_queryset(self, request, queryset, view):
        tour_length = request.query_params.get('tourLength', None)
        if tour_length:
            return queryset.filter(tour_length=tour_length)
        return queryset
...
class PackageViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = (CanWritePackageFilterBackend, TourLengthFilterBackend,)
